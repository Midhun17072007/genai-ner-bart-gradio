...
demo = gr.Interface(fn=ner,
                    ...
                    examples=["My name is Midhun and I live in California", "My name is Poli and work at HuggingFace"])
...
demo = gr.Interface(fn=ner,
                    ...
                    description="Find entities using the `dslim/bert-base-NER` model under the hood!",
                    allow_flagging="never",
                    examples=["My name is Midhun, I'm building DeeplearningAI and I live in California", "My name is Poli, I live in Vienna and work at HuggingFace"])

demo.launch(share=True, server_port=int(os.environ['PORT4']))
```
### OUTPUT:
#### Output 1:
<img width="1176" height="627" alt="image" src="https://github.com/user-attachments/assets/00ae6865-1544-4067-b04f-02494b23c016" />


#### Output 2:
<img width="1186" height="637" alt="image" src="https://github.com/user-attachments/assets/9fab8aa9-4abd-475c-86c4-1451d3a39556" />
